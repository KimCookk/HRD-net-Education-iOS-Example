...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        print("* QuaryModel Start!")
        queryModel.delegate = self
        queryModel.downloadItems()
        print("* QuearyModel End!")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "성명 : \(student.sname)"
        cell.detailTextLabel?.text = "학번 : \(student.scode)"
        // Configure the cell...
...
extension TableViewController: QueryModelProtocol{
    func itemDownloaded(items: [Student]) {
        ...
        // numberOfSections -> tableView 재구성
    }
}
